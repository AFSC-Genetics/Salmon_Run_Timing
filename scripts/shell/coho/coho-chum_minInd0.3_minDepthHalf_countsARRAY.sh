...
#SBATCH --job-name=counts_coho-chum
#SBATCH --output=/home/nhowe/runtiming/coho/job_outfiles/coho-chum_wholegenome_counts_%A-%a.out
...
PROJDIR="/home/nhowe/runtiming/coho"
PREFIX="coho-chum"
...
angsd -b ${PROJDIR}/${PREFIX}_early_bams.txt -r ${chrom}: \
	...
	-minMapQ 15 -minInd 13 -setminDepth 22 -setmaxDepth 450 \
...
angsd -b ${PROJDIR}/${PREFIX}_late_bams.txt -r ${chrom}: \
	...
	-nThreads 10 -uniqueOnly 1 -remove_bads 1 -trim 0 -C 50 -only_proper_pairs 1 \
	-minMapQ 15 -minInd 11 -setminDepth 19 -setmaxDepth 380 \
	-GL 1 -doMaf 1 -doMajorMinor 3 -doCounts 1 -dumpCounts 3
