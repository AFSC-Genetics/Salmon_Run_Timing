...
print(paste("Positional input has",length(pos_input),"files"))
...
print(paste("MAF input has",length(mafs_input),"files"))
...
print(paste("Counts input has",length(counts_input),"files"))
