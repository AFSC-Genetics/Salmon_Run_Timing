...
#SBATCH --output=/home/nhowe/runtiming/chum/job_outfiles/esrb_pca.%j.out # update your out file directory
#SBATCH --error=/home/nhowe/runtiming/chum/job_outfiles/esrb_pca.%j.err # update your error readout directory
